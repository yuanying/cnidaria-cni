...
| [0006](0006-next-hop-per-address-family.md) | Next hop per address family | InternalIP of the same family, or for IPv6 the address a node publishes in an annotation; a missing family is logged, not worked around; routes carry an ownership marker |
