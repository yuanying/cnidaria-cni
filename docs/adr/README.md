...
| [0004](0004-node-policy-crd-and-lockout-prevention.md) | NodePolicy CRD and lockout prevention | Cluster-scoped CRD shaped like NetworkPolicy, safe rules a policy cannot remove, commit-confirmed apply |
