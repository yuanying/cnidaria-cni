...
| [0004](0004-node-policy-crd-and-lockout-prevention.md) | NodePolicy CRD と締め出し防止 | NetworkPolicy に似せた cluster-scoped CRD、ポリシーで消せない安全ルール、commit-confirmed 方式の適用 |
